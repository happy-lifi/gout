package com.example.yang.gout.step.service;
...
import com.example.yang.gout.fragment.StepFragment;
import com.example.yang.gout.step.service.UpdateUiCallBack;
import com.example.yang.gout.step.accelerometer.StepCount;
import com.example.yang.gout.step.accelerometer.StepValuePassListener;
...
//                "new SimpleDateFormat(\"HH: mm\").format(new Date()))=" + new SimpleDateFormat("HH:mm").format(new Date()));
    ...
    private void updateNotification() {
        //设置点击跳转
        Intent hangIntent = new Intent(this,StepFragment.class);
